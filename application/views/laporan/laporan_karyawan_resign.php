          ...
          <form action="javascript:;">
            ...
            <div class="form-group col-md-2">
              ...
              <div class="input-group select2-bootstrap-prepend">
                ...
                <input type="text" class="form-control date-picker" placeholder="" name="from_date" id="from_date">
              </div>
            </div>
            ...
            <div class="form-group col-md-2">
              ...
              <div class="input-group select2-bootstrap-prepend" style="margin-top: 6px;">
                ...
                <input type="text" class="form-control date-picker" placeholder="" name="thru_date" id="thru_date">
              </div>
            </div>
            <div class="form-group col-md-4">
 ...
 jQuery(document).ready(function(){
  ...
  $(function(){
    ...
    $('#excel').click(function(){
      ...
      var from_periode1 = get_from_date.substr(3, 2);
      var from_periode2 = get_from_date.substr(0, 2);
      var from_periode3 = get_from_date.substr(6, 4);
      var from_date = from_periode3+'-'+from_periode1+'-'+from_periode2;

      var thru_periode1 = get_thru_date.substr(3, 2);
      var thru_periode2 = get_thru_date.substr(0, 2);
      var thru_periode3 = get_thru_date.substr(6, 4);
      var thru_date = thru_periode3+'-'+thru_periode1+'-'+thru_periode2;

      var site = '<?php echo site_url('laporan/action_laporan_karyawan_resign_excel'); ?>';
      var conf = true;
    ...
    $('#pdf').click(function(){
      ...
      var thru_periode3 = get_thru_date.substr(6, 4);
      var thru_date = thru_periode3+'-'+thru_periode1+'-'+thru_periode2;
      var site = '<?php echo site_url('laporan/action_laporan_karyawan_resign_pdf'); ?>';
      var conf = true;
