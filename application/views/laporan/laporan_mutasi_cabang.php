<div class="page-content" style="min-height: 860px;">
  ...
  <h1 class="page-title"> Laporan
    <small>Mutasi Cabang/Unit Karyawan</small>
  </h1>
  <div class="row">
    <div class="col-md-12">
...
<script>
 jQuery(document).ready(function() {    
      ...
      $('#excel').click(function(){
        ...
        var site = '<?php echo site_url('laporan/action_laporan_mutasi_cabang_excel'); ?>';
        var conf = true;
      ...
      $('#pdf').click(function(){
        ...
        var site = '<?php echo site_url('laporan/action_laporan_mutasi_cabang_pdf'); ?>';
        var conf = true;
