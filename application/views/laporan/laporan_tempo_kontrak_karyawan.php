<div class="page-content" style="min-height: 860px;">
  ...
  <h1 class="page-title"> Laporan
    <small>Jatuh Tempo Kontrak Karyawan</small>
  </h1>
  <div class="row">
    <div class="col-md-12">
          ...
          <form action="javascript:;">
            ...
            <div class="form-group col-md-2">
              ...
              <div class="input-group select2-bootstrap-prepend">
                ...
                <input type="text" class="form-control date-picker" placeholder="" id="from_date" name="from_date">
              </div>
            </div>
            ...
            <div class="form-group col-md-2">
              ...
              <div class="input-group select2-bootstrap-prepend" style="margin-top: 6px;">
                ...
                <input type="text" class="form-control date-picker" placeholder="" id="thru_date" name="thru_date">
              </div>
            </div>
            <div class="form-group col-md-4">
 ...
 jQuery(document).ready(function(){
  ...
  $(function(){
    ...
    $('#excel').click(function(){
      ...
      var site = '<?php echo site_url('laporan/action_laporan_jatuh_tempo_kontrak_karyawan_excel'); ?>';
      var conf = true;
    ...
    $('#pdf').click(function(){
      ...
      var site = '<?php echo site_url('laporan/action_laporan_jatuh_tempo_kontrak_karyawan_pdf'); ?>';
      var conf = true;
