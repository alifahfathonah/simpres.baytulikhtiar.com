...
<div style="width:100%;">
  ...
  LAPORAN MUTASI STATUS KARYAWAN
  </div>
  <div style="text-align:center;padding-top:10px;font-family:Arial;font-size:20px;">
...
<table id="hor-minimalist-b" align="center">
  <thead>
      ...
      <td class="title">Status Awal</td>
      <td class="title">Status Terakhir</td>
      <td class="title">Periode Status</td>
    </tr>
  </thead>
  <tbody>
    <?php 
  ...
  ?>    
    <tr>
      ...
      <td class="konten"><?php echo $values->from_status; ?></td>
      <td class="konten"><?php echo $values->thru_status; ?></td>
      <td class="konten"><?php echo $values->from_date.' s/d '.$values->thru_date;?></td>
    </tr>
    <?php } ?>
  </tbody>
</table>
