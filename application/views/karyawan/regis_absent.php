                    ...
                    <div class="page-content" style="min-height: 860px;">
                        ...
                        <h1 class="page-title"> Karyawan
                            <small>Regis Absent</small>
                        </h1>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="portlet light bordered">
                                  <form action="<?php echo site_url();?>karyawan/action_absent" role="form" method="post">
                                    <div class="portlet-body">
                                        <button id="sample_editable_1_new" class="btn sbold green" style="margin-bottom: 20px"  data-toggle="modal" href="#detail" type="button"> Pembatalan Cuti/Ijin
                                        </button>
                                        ...
                                        <div class="form-group" id="list">
                                            <label for="single" class="control-label">Jenis Absent</label>
                                                    <select class="form-control select2" name="kategori_cuti">
                                                        <option></option>
                                                        <?php foreach($get_parameter_absent as $values){?>
                                                            <option value="<?php echo $values->parameter_id;?>"><?php echo $values->description;?></option>
                                                        <?php }?>
                                                    </select>
                                        </div>
                                        <div class="form-group">
                                            <label for="default" class="control-label">Tanggal Absent</label>
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                            <thead>
                                                <tr>
                                                        ...
                                                        <th> Kategori Cuti/Ijin </th>
                                                        <th style="width: 250px;"> Keterangan </th>
                                                        <th style="width: 200px;"> Approve By </th>
                                                        <th> Actions </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                
                                                <?php foreach($get_absent as $values){?>                                                    
                                                <tr class="odd gradeX">
                                                    <td><?php echo $values->fullname;?></td>
                                                    <td><?php echo $values->tgl_cuti;?></td>
                                                    <td><?php echo $values->kat_cuti;?></td>
                                                    <td><?php echo $values->keterangan;?></td>
                                                    <td><?php echo $values->aprove;?></td>
                                                    <td><a href="<?php echo site_url()?>karyawan/action_batal_cuti/<?php echo $values->alfa_id;?>/<?php echo $values->nik;?>/<?php echo $values->kategori_cuti?>/<?php echo $values->tgl_cuti;?>" class="btn btn-sm btn-outline grey-salsa"><i class="fa fa-search"></i> Batalkan</a></td>
                                                </tr>
                                                <?php }?>
