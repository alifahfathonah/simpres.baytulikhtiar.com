                    ...
                    <div class="page-content" style="min-height: 860px;">
                        ...
                        <h1 class="page-title"> Karyawan
                            <small>Regis Tugas Luar Kantor</small>
                        </h1>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="portlet light bordered">
                                  <form action="<?php echo site_url();?>karyawan/action_tlk" role="form" method="post">
                                    <div class="portlet-body">
                                        <button id="sample_editable_1_new" class="btn sbold green" style="margin-bottom: 20px"  data-toggle="modal" href="#detail" type="button"> Pembatalan TLK
                                        </button>
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                            <thead>
                                                <tr>
                                                        ...
                                                        <th style="width: 150px;"> Tanggal TLK </th>
                                            ...
                                            <tbody>
                                                ...
                                                <?php foreach($get_tlk as $values){?>                                                    
                                                <tr class="odd gradeX">
                                                    <td><?php echo $values->fullname;?></td>
                                                    <td><?php echo $values->tgl_tlk;?></td>
                                                    <td><?php echo $values->keterangan;?></td>
                                                    <td><a href="<?php echo site_url()?>karyawan/action_batal_tlk/<?php echo $values->tlk_id;?>/<?php echo $values->nik;?>/<?php echo $values->tgl_tlk;?>" class="btn btn-sm btn-outline grey-salsa"><i class="fa fa-search"></i> Batalkan</a></td>
                                                </tr>
                                                <?php }?>
