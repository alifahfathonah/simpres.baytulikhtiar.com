                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="portlet light bordered">
                                  <form action="<?php echo site_url();?>mutasi/action_mutasi_jabatan" role="form" method="post">
                                    <div class="portlet-body">
                                        ...
                                        <div class="form-group">
                                            <label for="single" class="control-label">Mutasi Jabatan Ke </label>
                                                    <select id="single-prepend-text" class="form-control select2" name="jabatan">
                                                        <option></option>
                                                        <?php foreach($get_position as $value){?>
                                                            <option value="<?php echo $value->position_code;?>"><?php echo $value->position_name;?></option>
                                                        <?php }?>
                                                    </select>
                                        </div>
                                        <div class="form-group">
