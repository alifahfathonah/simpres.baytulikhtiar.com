...
function()
{
                    ...
                    n = function()
                    {
                        ...
                        dataTable:{bStateSave:!0,
                            ...
                            pageLength:10,ajax:{url:"<?php echo base_url();?>karyawan/get_karyawan"},
                            order:[[1,"asc"]],
                            buttons:[
                    ...
                    $("#datatable_ajax_tools > li > a.tool-action").on("click",function(){var t=$(this).attr("data-action");
