          ...
          <form action="<?php echo site_url();?>absensi/get_absen_by_nik" role="form" method="post">
            ...
            <div class="form-group">
              ...
              <a href="<?php echo site_url('absensi');?>">
                <button type="button" class="btn grey-mint sbold uppercase" style="margin-top: 24px">Back</button>
              </a>
                    ...
                    foreach($get_presensi_by_nik as $values)                  
                    {
                      if($values->masuk == '' && $values->keluar == '' && $values->tanggal < date('Y-m-d'))
                      {
                        ...
                        <tr style="text-align: center;">
                          ...
                          <td><input class="form-control" placeholder="HH:MM:DD" style="text-align: center;" id="mask_number" type="text" name="datang<?php echo $i;?>" <?php if($values->keterangan != ''){echo "";}?>></td>
                          <td><input class="form-control" placeholder="HH:MM:DD" style="text-align: center;" id="mask_number" type="text" name="pulang<?php echo $i;?>" <?php if($values->keterangan != ''){echo "";}?>></td>
                          <td><input class="form-control" type="text" name="keterangan<?php echo $i;?>" <?php if($values->keterangan != ''){echo "value='".$values->keterangan."'  style='color: red; text-align: center'";}else{echo "value='Tidak Hadir' style='text-align: center'";}?>></td>
                        </tr>
                        <?php   
                        ...
                        <tr style="text-align: center;">
                          <td><?php echo $values->tanggal;?></td>
                          <input type="text" value="<?php echo $values->tanggal?>" name="tanggal<?php echo $i;?>" hidden="hidden">
                          <td><input placeholder="HH:MM:DD" id="mask_number" type="text" name="datang<?php echo $i;?>" <?php if($values->masuk != ''){ if($values->masuk >= '01:00:00' && $values->masuk <= '08:01:00'){echo "value='".$values->masuk."'  class='form-control'";}else if($values->masuk > '08:01:00' && $values->masuk < '12:00:00'){ echo "value='".$values->masuk."'  class='form-control' style='color: red; text-align: center'";}else if($values->masuk == '12:00:00'){echo "value='".$values->masuk."' class='form-control'";}}else{ if($values->keterangan != ''){echo "value=''  class='form-control'";}else{ echo "value='' class='form-control'";}}?> style="text-align: center;"></td>
                          <td><input placeholder="HH:MM:DD" id="mask_number" type="text" name="pulang<?php echo $i;?>" <?php if($values->keluar != ''){ if($values->keluar == '12:00:00'){echo "value='".$values->keluar."' class='form-control'";}else if($values->keluar > '12:00:00' && $values->keluar < '17:00:00'){echo "value='".$values->keluar."'   class='form-control' style='color: red; text-align: center'";}else{echo "value='".$values->keluar."'   class='form-control'";}}else{if($values->keterangan != ''){echo "value=''  class='form-control'";}else{echo "value='' class='form-control'";}}?> style="text-align: center;"></td>
                          <td><input class="form-control" type="text" name="keterangan<?php echo $i;?>" <?php if($values->keterangan != ''){if(substr($values->keterangan, 0, 2) == 'TL'){echo "value='".substr($values->keterangan, 2)."'  style='text-align: center'";}else{echo "value='".$values->keterangan."'  style='color: red; text-align: center'";}}else{ if($values->masuk != '' || $values->keluar != ''){echo "value=''";}else{echo "value='Tidak Hadir' style='text-align: center'";}}?>></td>
                        </tr>
                        <?php                                                         
                        $i++;
                      }           
