                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td style="text-align: center;"><a href="<?php echo site_url()?>setup/get_position_by_id/<?php echo $values->parameter_id;?>" class="btn btn-sm btn-outline grey-salsa"><i class="fa fa-search"></i> View</a></td>
                                                </tr>
                                                <?php }?>
