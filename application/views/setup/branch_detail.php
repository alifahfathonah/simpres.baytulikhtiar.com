                    ...
                    <div class="page-content" style="min-height: 860px;">
                        ...
                        <h1 class="page-title"> Setup
                            <small> Cabang Detail</small>
                        </h1>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="portlet light bordered">
                                  <form action="<?php echo site_url();?>setup/update_branch/<?php echo $branch_id;?>" role="form" method="post">
                                    <div class="portlet-body">
                                        <div class="form-group">
                                            <label for="default" class="control-label">Nama Cabang</label>
                                            <?php foreach($get_branch_by_id as $values){?>
                                            <input name="branch" type="text" class="form-control" value="<?php echo $values->description?>"> 
                                            <?php }?>
                                        </div>
                                            <div class="form-group">
